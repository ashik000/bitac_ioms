...
class DowntimeReportRepository
{
    ...
    public function getDowntimeTableReportByStationV2()
    {
        $stationId = 1;
        ...
        if (is_null($stationId)) {
            $result = Downtime::query()
                ...
                ->groupBy(['downtimes.start_time,downtime_reasons.type','station_id','station_group_id','station_name','stations.station_group_id','station_group_name'])
                ->select([
                    'station_id',
                    'station_group_id',
                    ...
                    DB::raw('downtimes.start_time as date')
                ])->get();
