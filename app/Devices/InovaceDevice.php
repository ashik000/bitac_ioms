...
//
//        $topProductionLogId = empty($topProductionLog)? 1 : $topProductionLog->id + 1;
//        $topSlowProductionId = empty($topSlowProduction)? 1 : $topSlowProduction->id + 1;
//        $topDowntimeId = empty($topDowntime)? 1 : $topDowntime->id + 1;
//
//        $cycleInterval = 0;
//        $productionLogs = [];
//        $slowProductions = [];
...
//            if(empty($previousProductionLog)) {
...
//                $previousProductionLog->produced_at = Carbon::parse($previousProductionLog->produced_at);
//            }
//            if(empty($previousProductionLog)) {
//                $previousProductionLog = new ProductionLog();
//                $previousProductionLog->produced_at = Carbon::now()->startOfDay();
//            }
//            Log::debug('Creating prod log');
//            $productionLogs[] = [
//                'id' => empty($topProductionLog) ? 1 : ++$topProductionLogId,
...
//                'updated_at' => now()
//            ];
//            Log::debug($previousProductionLog->produced_at->copy());
//            $hourDiff = $this->diffInHours($logTimeObject->copy()->startOfHour(), $previousProductionLog->produced_at->copy()->startOfHour());
//            if($hourDiff >= 2) {
//
//                $downtimePrevStartTime = Carbon::parse($previousProductionLog->produced_at);
//                $downtimePrevDuration = $downtimePrevStartTime->copy()->endOfHour()->diffInSeconds($downtimePrevStartTime);
//                $downtimes[] = [
//                    'id' => empty($topDowntime)? 1 : ++$topDowntime,
...
//                ];
//
//                $hour = $downtimePrevStartTime->copy()->startOfHour()->addHour();
//                for($j = 0; $j < $hourDiff - 1; $j++) {
//                    Log::debug('diff');
//                    Log::debug($hourDiff);
//                    $downtimeStart = $hour->startOfHour();
//                    $downtimeDuration = 3600;
//                    $downtimes[] = [
//                        'id' => empty($topDowntime)? 1 : ++$topDowntime,
//                        'production_log_id' => $topProductionLogId,
...
//            }
//
//            if($cycleInterval > $stationProduct->cycle_time + $stationProduct->cycle_timeout) { //downtime and slowprod
//
//            }
//            else if($cycleInterval > $stationProduct->cycleTime) {
//                $totalSlowProductionDuration = $cycleInterval - $stationProduct->cycle_time;
//                $slowProductionStart = Carbon::parse($previousProductionLog->produced_at);
//                $slowProductionEnd = $slowProductionStart->copy()->addSeconds($totalSlowProductionDuration);
//                if($slowProductionStart->hour != $slowProductionEnd->hour) { // two slow prods
//                    $slowProductions[] = [
//                        'id' => empty($topSlowProduction)? 1 : ++$topSlowProductionId,
//                        'production_log_id' => $topProductionLogId,
//                        'start_time' =>  $slowProductionStart,
//                        'duration' => $slowProductionStart->copy()->endOfHour()->diffInSeconds($slowProductionStart),
//                        'created_at' => now(),
//                        'updated_at' => now()
//                    ];
//                    $durationLeft = $totalSlowProductionDuration - $slowProductionStart->copy()->endOfHour()->diffInSeconds($slowProductionStart);
//                    $slowProductions[] = [
//                        'id' => empty($topSlowProduction)? 1 : ++$topSlowProductionId,
//                        'production_log_id' => $topProductionLogId,
//                        'start_time' =>  $slowProductionStart->copy()->addHour()->startOfHour(),
...
//                        'production_log_id' => $topProductionLogId,
//                        'start_time' =>  $slowProductionStart,
//                        'duration' => $totalSlowProductionDuration,
//                        'created_at' => now(),
//                        'updated_at' => now()
//                    ];
//                }
