<template>
    <div>
        <report-filters-for-station-wise-report v-if="reportType==='station'" v-on="$listeners"></report-filters-for-station-wise-report>
...
<script>
    import ReportFiltersForStationWiseReport from './ReportFiltersForStationWiseReport';
