    ...
    <nav>
        <div class="row">
            ...
            <div class="col-sm-3 ps-0">
                ...
                <select class="form-select form-select-sm" v-model="selectedProductGroupId">
                    <option value="0">All</option>
                    <option v-for="productGroup in productGroups" :value="productGroup.id" :key="productGroup.id">{{ productGroup.name }}</option>
                </select>
            </div>
            <div class="col-sm-3 ps-0">
                <label>Product (with station)</label>
                <select class="form-select form-select-sm" v-model="selectedStationProductId">
                    <option value="0">All</option>
