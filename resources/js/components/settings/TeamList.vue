        ...
        <div class="card-header">
            ...
            <div class="d-flex pe-3">
                <div class="input-group remove-width">
                    <input v-model="searchString" type="text" class="form-control btn-sm rounded-2" placeholder="Search" aria-label="Operator Search" aria-describedby="Product search">
